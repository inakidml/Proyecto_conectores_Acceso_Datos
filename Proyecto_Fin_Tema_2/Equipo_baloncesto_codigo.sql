...
CREATE TABLE IF NOT EXISTS `mydb`.`JUGADOR` (
  ...
  PRIMARY KEY (`idJUGADOR`, `EQUIPO_idEquipo`),
...
CREATE INDEX `fk_JUGADOR_EQUIPO1_idx` ON `mydb`.`JUGADOR` (`EQUIPO_idEquipo` ASC);
...
CREATE INDEX `fk_INCIDENCIA_has_JUGADOR_JUGADOR1_idx` ON `mydb`.`INCIDENCIA_has_JUGADOR` (`JUGADOR_idJUGADOR` ASC);

CREATE INDEX `fk_INCIDENCIA_has_JUGADOR_INCIDENCIA1_idx` ON `mydb`.`INCIDENCIA_has_JUGADOR` (`INCIDENCIA_idINCIDENCIA` ASC);
...
CREATE INDEX `fk_JUGADOR_has_ENTRENAMIENTO_ENTRENAMIENTO1_idx` ON `mydb`.`JUGADOR_has_ENTRENAMIENTO` (`ENTRENAMIENTO_idENTRENAMIENTO` ASC);

CREATE INDEX `fk_JUGADOR_has_ENTRENAMIENTO_JUGADOR1_idx` ON `mydb`.`JUGADOR_has_ENTRENAMIENTO` (`JUGADOR_idJUGADOR` ASC);
